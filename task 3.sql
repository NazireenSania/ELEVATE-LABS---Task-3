...
# Get users who performed more events than the average number of events.
...
# Optimize queries filtering by user_id and occurred_at.


CREATE INDEX idx_user_event_time ON events(user_id, occurred_at);
